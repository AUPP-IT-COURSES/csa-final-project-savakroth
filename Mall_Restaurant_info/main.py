...
class StartPage(Frame):
    def __init__(self, parent, controller):
        ...
        self.background_img = ImageTk.PhotoImage(file='images/11.png')
        ...
        self.logo_viewstalls = ImageTk.PhotoImage(file="images/Viewfood.png")
        ...
        self.logo_datetime = ImageTk.PhotoImage(file="images/datetime.png")
        ...
        self.logo_howtouse = ImageTk.PhotoImage(file="images/howtouseX.png")
...
class IndividualStallPage(Frame):
    def __init__(self, parent, controller):
        ...
        self.address = Label(self, font=LARGE_FONT, justify=LEFT, fg='black', bg='black')
...
class InstructionPage(Frame):
    def __init__(self, parent, controller):
        ...
        self.background_img = ImageTk.PhotoImage(file='images/10.png')
        self.background = Label(self, image=self.background_img)
        self.background.place(relwidth=1, relheight=1)
...
pygame.mixer.init()
pygame.mixer.music.load("assets/WelcomeMusic.ogg")
pygame.mixer.music.play(-1)

# --------MAIN GUI---------------------------------------------------------------------------------------------------------------------------------------------------
GUI = window()
GUI.title("MALL BISTRO INFORMATION SYSTEM")
